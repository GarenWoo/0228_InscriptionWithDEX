...
## B. ERC20TokenFactory_V2 合约（铭文铸造工厂）
...
### 2. 方法 {deployInscription} ：创建新的铭文合约
...
### 4. 方法 {withdrawProfitFromMinting}：项目方提取用户铸造铭文对应的收益
...
### 5. 方法 {withdrawProfitFromLiquidity}：项目方提取流动性的收益
...
### 6. 只读方法 {getPairAddress}：获取 LP token 合约地址
...
### 7. 只读方法 {getLPProfitAmount}：获取可用于提取流动性收益的 LP token 数量
...
### 8. 内部方法 {_beforeMintInscription}：在铸造铭文之前的检查
