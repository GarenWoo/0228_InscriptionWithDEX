...
![IMG1_TestResults](./images/IMG1_TestResults.png)

## 5. 合约交互与前端页面展示

创建新铭文合约，并铸造一次铭文，在前端页面显示如下：

![IMG2_FrontPageAfterMint](./images/IMG2_FrontPageAfterMint.png)

在区块浏览器中可以获取该铭文的信息：

![IMG2_InscriptionInfo](./images/IMG3_InscriptionInfo.png)
